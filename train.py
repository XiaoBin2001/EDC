    ...
    if iteration in testing_iterations:
        ...
        for config in validation_configs:
            if config['cameras'] and len(config['cameras']) > 0:
                ...
                print("[ITER {}] Evaluating {}: L1 {} PSNR {} Size {}".format(iteration, config['name'], l1_test, psnr_test, int(size)))
                if tb_writer:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations",
                        nargs="+",
                        type=int,
                        default=[3_000, 6_000, 9_000, 12_000, 15_000, 18_000, 21_000, 24_000, 27_000, 30_000]
                        )  # 测试迭代次数
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[30_000])  # 保存迭代次数
